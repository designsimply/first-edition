...
function first_edition_paging_nav() {
	...
	<nav class="navigation paging-navigation" role="navigation">
		<h1 class="screen-reader-text"><?php _e( 'Posts navigation', 'first-edition' ); ?></h1>
		<div class="nav-links">
...
function first_edition_post_nav() {
	...
	<nav class="navigation post-navigation" role="navigation">
		<h1 class="screen-reader-text"><?php _e( 'Post navigation', 'first-edition' ); ?></h1>
		<div class="nav-links">
			<?php
...
function first_edition_posted_on() {
	...
	printf( __( '<span class="posted-on">Posted on %1$s</span><span class="byline"> by %2$s</span>', 'first-edition' ),
